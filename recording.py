    ...
    def analyze(self,analyzer,config,save=True):
        ...
        for i_analyzed in range(0, num_window):
            ...
            for i in range(n_bands):
                ...
                #print(self.predictedProbas[i, i_analyzed].reshape(1, -1))
                #print(self.predictedProbas[i, i_analyzed].shape)
                #print(self.predictedProbas[i, i_analyzed].reshape(1, -1).shape)
